...
<!-- main begin-->
      ...
      <c:forEach var="auction" items="${auctionList}" varStatus="state">
	      ...
	      >
	        ...
	        <li class="borderno red">
	            ...
	            <c:if test="${sessionScope.user.userisadmin==1}">
	            	<a href="${pageContext.request.contextPath}/auction/toUpdate/${auction.auctionid}" title="修改" onclick="dele();">修改</a>|
	            	<!-- 用JavaScript实现提示是否删除 -->
  ...
  <script>
  	...
  	//传过来前“i”是小写，这里形参是大写，方法要以形参为准，这里的auctionId似乎只是用来找路径？？
