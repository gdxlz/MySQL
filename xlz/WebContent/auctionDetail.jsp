...
<!-- main begin-->
  <div class="sale">
    <h1 class="lf">在线拍卖系统</h1>
	    ...
	    <c:if test="${sessionScope.user != null}">
	    	 <div class="logout right"><a href="${pageContext.request.contextPath}/user/logout" title="注销">注销</a></div>
	    </c:if>
	    <c:if test="${sessionScope.user == null}">
  ...
  <div class="rg borders"><img src="${pageContext.request.contextPath}/images/${auctionDetail.auctionpic}" width="270" height="185" alt="" /></div>
  <div class="cl"></div>
  
  <form action="${pageContext.request.contextPath}/auction/saveAuctionRecord" method="post">
	  <div class="top10 salebd">
	       <p>
		       <label for="sale">出价：</label>
		       <input type="text" class="inputwd" name="auctionprice" />
		       <input type="text" hidden="hidden" name="auctionid" value="${auctionDetail.auctionid}"/>
